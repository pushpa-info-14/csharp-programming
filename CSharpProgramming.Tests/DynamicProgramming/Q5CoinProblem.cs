...
public class Q5CoinProblem(ITestOutputHelper output) : BaseTest(output)
{
	...
	public void Test()
	{
		var s = new CoinProblem();
		Print(s.MinimumCoinsMemo(13, [1, 4, 5]));
		Print(s.MinimumCoinsMemo(150, [1, 4, 5]));
		Print(s.MinimumCoinsBottomUp(13, [1, 4, 5]));
		Print(s.MinimumCoinsBottomUp(150, [1, 4, 5]));
		Print(s.HowManyWays(13, [1, 4, 5]));
		Print(s.HowManyWays(150, [1, 4, 5]));
	}
}
